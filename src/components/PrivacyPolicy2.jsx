  ...
  return (
    <>
      <div className="bg-[#0D1B2A] px-8 md:px-20 lg:px-40 py-10 text-white">
        {/* Heading 1 */}
        <h1 className="text-xl md:text-4xl text-white font-bold mb-6">Privacy Policy</h1>
        <p className="text-md md:text-xl mb-4">Last Updated: 11/01/2024</p>
        ...
        {/* Section 1 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">1. Information We Collect</h2>
        ...
        {/* Section 2 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">2. How We Use Your Information</h2>
        <p className="text-md md:text-lg mb-6">
        ...
        {/* Section 3 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">3. Sharing Your Information</h2>
        <p className="text-md md:text-lg mb-6">
        ...
        {/* Section 4 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">4. Data Security</h2>
        <p className="text-md md:text-lg mb-6">
        ...
        {/* Section 5 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">5. Your Choices</h2>
        <p className="text-md md:text-lg mb-6">You have the following choices regarding your information:</p>
        <ul className="list-disc pl-6 mb-6 text-md md:text-lg">
        ...
        {/* Section 6 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">6. Children’s Privacy</h2>
        <p className="text-md md:text-lg mb-6">
        ...
        {/* Section 7 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">7. Changes to This Privacy Policy</h2>
        <p className="text-md md:text-lg mb-6">
        ...
        {/* Section 8 */}
        <h2 className="text-xl md:text-2xl font-semibold mt-6 mb-4">8. Contact Us</h2>
        <p className="text-md md:text-lg mb-6">
