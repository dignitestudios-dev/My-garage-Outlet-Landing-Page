  ...
  return (
    <>
      ...
      <div className="bg-[#0D1B2A] px-8 md:px-20 lg:px-40 py-10 text-white">
        <h1 className="text-4xl text-white font-bold mb-6">My Garage Outlet Child Safety Policy</h1>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">2. General Guidelines</h2>
        ...
        <p className="text-lg mb-4">To protect children, the following activities are strictly prohibited on My Garage Outlet:</p>
        <ul className="list-disc pl-6 mb-6 text-lg space-y-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">4. Reporting and Enforcement</h2>
        <ul className="list-disc pl-6 mb-6 text-lg space-y-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">5. Safety Recommendations for Families</h2>
        <ul className="list-disc pl-6 mb-6 text-lg space-y-2">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">6. Continuous Policy Review</h2>
        <p className="text-lg mb-6">
